...
const constrainHeight = (top /*: number*/, currentHeight /*: number*/, newHeight /*: number*/, parentLowerBoundary /*: number*/) => {
  return top < 0 || top + newHeight > parentLowerBoundary ? currentHeight : newHeight;
};
...
const resizeSouth = (currentSize, _ref4, containerWidth, parentLowerBoundary) => {
  let {
    top,
    left,
    height,
  ...
  return {
    width,
    left,
    height: constrainHeight(top, currentSize.height, height, parentLowerBoundary),
    top: constrainTop(top)
  };
};
...
const resizeSouthEast = function () {
  return resizeSouth(arguments.length <= 0 ? undefined : arguments[0], resizeEast(...arguments), arguments.length <= 2 ? undefined : arguments[2], arguments.length <= 3 ? undefined : arguments[3]);
};
 ...
 */
function resizeItemInDirection(direction /*: ResizeHandleAxis*/, currentSize /*: Position*/, newSize /*: Position*/, containerWidth /*: number*/, parentLowerBoundary /*: number*/) /*: Position*/{
  ...
  return ordinalHandler(currentSize, {
    ...currentSize,
    ...newSize
  }, containerWidth, parentLowerBoundary);
}
